package com.bridgeit.spring.dao;
...
public class EmployeeDao {
	...
	public int save(Employee p) {
		String sql = "insert into Employee1(name,salary,designation) values('" + p.getName() + "', " + p.getSalary()
				+ ",'" + p.getDesignation() + "')";
	...
	public int update(Employee p) {
		String sql = "update Employee1 set name='" + p.getName() + "', salary=" + p.getSalary() + ",designation='"
